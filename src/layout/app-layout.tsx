...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Bill', path: '/bills', entity: 'bill', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    { name: 'Item', path: '/items', entity: 'item', service: AccessServiceEnum.PROJECT, icon: FiShoppingBag },
